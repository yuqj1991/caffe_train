...
class faceContourDataLayer: public BasePrefetchingDataLayer<Dtype>{
    public:
        explicit faceContourDataLayer(const LayerParameter & param);
        virtual ~faceContourDataLayer();
        ...
        virtual inline const char* type() const { return "faceContourData"; }
