...
template class BlockingQueue<AnnoFaceDatum*>;
...
template class BlockingQueue<AnnoBlurDatum*>;
...
template class BlockingQueue<shared_ptr<DataReader<AnnoFaceAttributeDatum>::QueuePair> >;
...
template class BlockingQueue<shared_ptr<DataReader<AnnoBlurDatum>::QueuePair> >;
