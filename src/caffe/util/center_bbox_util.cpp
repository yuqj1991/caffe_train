...
Dtype EncodeCenterGridObjectSoftMaxLoss(const int batch_size, const int num_channels, const int num_classes,
  ...
  *loc_loss_value = loc_loss;
  ...
  Dtype test_pred_data[] = {25.46, 78.25, 35.14, 74.12,35.45, 25.15, 43.23, 36.34,
                                            25.46, 78.25, 35.14, 74.12,35.45, 25.15, 43.23, 36.34,
                                            25.46, 78.25, 35.14, 74.12,35.45, 25.15, 43.23, 36.34,
                                            25.46, 78.25, 35.14, 74.12,35.45, 25.15, 43.23, 36.34,
                                            25.46, 78.25, 35.14, 74.12,35.45, 25.15, 43.23, 36.34,
                                            25.46, 78.25, 35.14, 74.12,35.45, 25.15, 43.23, 36.34, 
                                            16.43, 67.27, 27.89, 37.44,19.22, 28.55, 35.32, 44.33,
                                            16.43, 67.27, 27.89, 37.44,19.22, 28.55, 35.32, 44.33,
                                            16.43, 67.27, 27.89, 37.44,19.22, 28.55, 35.32, 44.33,
                                            16.43, 67.27, 27.89, 37.44,19.22, 28.55, 35.32, 44.33,
                                            16.43, 67.27, 27.89, 37.44,19.22, 28.55, 35.32, 44.33,
                                            16.43, 67.27, 27.89, 37.44,19.22, 28.55, 35.32, 44.33};
  Dtype test_bottom_diff[48];
  Dtype test_loss = SoftmaxLossEntropy(test_class_label, test_pred_data, 2, 2,
                        2, test_bottom_diff, 6);
