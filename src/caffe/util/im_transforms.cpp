...
void UpdateLandmarkFacePoseByResizePolicy(const ResizeParameter& param,
  ...
  float new_height = param.height();
  float new_width = param.width();
  float x1 = lface->facecour().point_1().x();
  float y1 = lface->facecour().point_1().y();
  float x2 = lface->facecour().point_2().x();
  float y2 = lface->facecour().point_2().y();
  float x3 = lface->facecour().point_3().x();
  float y3 = lface->facecour().point_3().y();
  float x4 = lface->facecour().point_4().x();
  float y4 = lface->facecour().point_4().y();
  float x5 = lface->facecour().point_5().x();
  float y5 = lface->facecour().point_5().y();
  float x6 = lface->facecour().point_6().x();
  float y6 = lface->facecour().point_6().y();
  float x7 = lface->facecour().point_7().x();
  float y7 = lface->facecour().point_7().y();
  float x8 = lface->facecour().point_8().x();
  float y8 = lface->facecour().point_8().y();
  float x9 = lface->facecour().point_9().x();
  float y9 = lface->facecour().point_9().y();
  float x10 = lface->facecour().point_10().x();
  float y10 = lface->facecour().point_10().y();
  float x11 = lface->facecour().point_11().x();
  float y11 = lface->facecour().point_11().y();
  float x12 = lface->facecour().point_12().x();
  float y12 = lface->facecour().point_12().y();
  float x13 = lface->facecour().point_13().x();
  float y13 = lface->facecour().point_13().y();
  float x14 = lface->facecour().point_14().x();
  float y14 = lface->facecour().point_14().y();
  float x15 = lface->facecour().point_15().x();
  float y15 = lface->facecour().point_15().y();
  float x16 = lface->facecour().point_16().x();
  float y16 = lface->facecour().point_16().y();
  float x17 = lface->facecour().point_17().x();
  float y17 = lface->facecour().point_17().y();
  float x18 = lface->facecour().point_18().x();
  float y18 = lface->facecour().point_18().y();
  float x19 = lface->facecour().point_19().x();
  float y19 = lface->facecour().point_19().y();
  float x20 = lface->facecour().point_20().x();
  float y20 = lface->facecour().point_20().y();
  float x21 = lface->facecour().point_21().x();
  float y21 = lface->facecour().point_21().y();
  switch (param.resize_mode()) {
    case ResizeParameter_Resize_mode_WARP:
      x1 = std::max(0.f, x1 * new_width / old_width);
      x1 = std::min(new_width, x1 * new_width / old_width);
  ...
  lface->piont_1().set_x(x1);
  lface->piont_1().set_y(y1);
  lface->piont_2().set_x(x2);
  lface->piont_2().set_y(y2);
  lface->piont_3().set_x(x3);
  lface->piont_3().set_y(y3);
  lface->piont_4().set_x(x4);
  lface->piont_4().set_y(y4);
  lface->piont_5().set_x(x5);
  lface->piont_5().set_y(y5);
  lface->piont_6().set_x(x6);
  lface->piont_6().set_y(y6);
  lface->piont_7().set_x(x7);
  lface->piont_7().set_y(y7);
  lface->piont_8().set_x(x8);
  lface->piont_8().set_y(y8);
  lface->piont_9().set_x(x9);
  lface->piont_9().set_y(y9);
  lface->piont_10().set_x(x10);
  lface->piont_10().set_y(y10);
  lface->piont_11().set_x(x11);
  lface->piont_11().set_y(y11);
  lface->piont_12().set_x(x12);
  lface->piont_12().set_y(y12);
  lface->piont_13().set_x(x13);
  lface->piont_13().set_y(y13);
  lface->piont_14().set_x(x14);
  lface->piont_14().set_y(y14);
  lface->piont_15().set_x(x15);
  lface->piont_15().set_y(y15);
  lface->piont_16().set_x(x16);
  lface->piont_16().set_y(y16);
  lface->piont_17().set_x(x17);
  lface->piont_17().set_y(y17);
  lface->piont_18().set_x(x18);
  lface->piont_18().set_y(y18);
  lface->piont_19().set_x(x19);
  lface->piont_19().set_y(y19);
  lface->piont_20().set_x(x20);
  lface->piont_20().set_y(y20);
  lface->piont_21().set_x(x21);
  lface->piont_21().set_y(y21);
}
