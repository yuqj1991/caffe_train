...
#include "caffe/layers/channel_normalize_layer.hpp"

namespace caffe {

template <typename Dtype>
void ChannelNormalizeLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  ChannelNormalizeParameter norm_param = this->layer_param().norm_param();
...
template <typename Dtype>
void ChannelNormalizeLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  CHECK_GE(bottom[0]->num_axes(), 2)
      << "Number of axes of bottom blob must be >=2.";
...
template <typename Dtype>
void ChannelNormalizeLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void ChannelNormalizeLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(ChannelNormalizeLayer);
#endif
