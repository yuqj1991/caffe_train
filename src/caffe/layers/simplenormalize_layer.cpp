...
template <typename Dtype>
void SimpleNormalizeLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SimpleNormalizeLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(SimpleNormalizeLayer);
#endif

INSTANTIATE_CLASS(SimpleNormalizeLayer);
REGISTER_LAYER_CLASS(SimpleNormalize);
