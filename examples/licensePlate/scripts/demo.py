...
def parse_args():
    ...
    parser.add_argument('--labelmap_file',
                        default= '{}examples/licensePlate/scripts/labelmap_lp.prototxt'.format(caffe_root))
    parser.add_argument('--ssd_model_def',
                        default= '{}examples/licensePlate/net/SSD_300x300/deploy.prototxt'.format(caffe_root))
    parser.add_argument('--ssd_image_resize', default=300, type=int)
    parser.add_argument('--ssd_model_weights',
                        default= '{}examples/licensePlate/net/SSD_300x300/lpr_detection.caffemodel'.format(caffe_root))


    parser.add_argument('--image_dir', default='{}examples/licensePlate/images/'.format(caffe_root))
