...
net, LayerList_Output = CenterGridMobilenetV3Body(net= net, from_layer= 'data')
...
net, LayerList_Output = CenterGridMobilenetV3Body(net, from_layer = 'data', Use_BN= True, use_global_stats= True)
DetectListLayer = []
DetectListScale = []
DetectListDownRatio = []
