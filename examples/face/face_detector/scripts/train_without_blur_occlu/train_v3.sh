...
../../../../../build/tools/caffe train --solver=../../solver/solver_without_blur_occlu/solver_train_v3.prototxt -gpu 0 \
#--snapshot=../../snapshot/face_detector_without_v3_iter_6791.solverstate
