...
../../../../../build/tools/caffe train --solver=../../solver/solver_without_blur_occlu/solver_train_v5.prototxt -gpu 0 \
#--snapshot=../../snapshot/face_detector_without_v1_iter_106502.solverstate
