...
# regular convolution layer.and relu layer
def conv_relu(bottom, kernel_size, nout, stride, pad, group=1):
	conv = L.Convolution(bottom, kernel_size=kernel_size, stride=stride, num_output=nout, pad=pad, group=group)
